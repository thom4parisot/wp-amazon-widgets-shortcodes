...
$strings = 'tinyMCE.addI18n("'.$mce_locale.'.wpAwshortcode",{
  ...
  amazon_mp3:           "'.js_escape(__('Amazon MP3', 'awshortcode')).'",
...
tinyMCE.addI18n("'.$mce_locale.'.wpAwshortcode_dlg",{
  ...
  apply_the_magic_err:  "'.js_escape(__('Could not parse Amazon HTML code. It may be invalid or it is a bug of the plugin (then, please report it).', 'awshortcode')).'",
